...
imgUrl = "http://tropic.ssec.wisc.edu/real-time/atlantic/images/irng8.GIF"
# where the image folder is saved
imageFolderPath = "./"
# gifFolderPath = "/home/bkwq4309/public_html/"
gifFolderPath = "./"
...
def createVideo(imageFodlerPath, gifFolderPath):
    ...
    frames[0].save('{}animation-temperature.gif'.format(gifFolderPath), format='GIF', append_images=frames[1:],
